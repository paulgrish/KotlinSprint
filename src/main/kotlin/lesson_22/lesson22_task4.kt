 ...
 *
 * Создайте метод loadData() в классе MainScreenViewModel, который будет имитировать процесс загрузки данных с сервера.
 * Этот метод не должен принимать параметры и должен последовательно изменять состояние в следующем порядке:
 *
 * - отсутствие данных;
 * - загрузка данных;
